  ...
  if (items.length === 0) {
    return (
      <div className="container-app flex flex-col items-center py-20 text-center">
        <span className="mb-4 inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-brand-soft text-brand">
        ...
        <p className="mt-2 max-w-md text-muted">
          Browse restaurants and add dishes to start building your order.
        </p>
        <Link
          to="/restaurants"
  ...
  return (
    <div className="container-app py-8 sm:py-10">
      ...
      <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
        ...
        {/* Subtotal, delivery fee, taxes, total + checkout */}
